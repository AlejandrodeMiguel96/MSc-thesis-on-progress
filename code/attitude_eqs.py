...
def quat2dcm_inertial2body(q):
    """
    Converts quaternion to DCM matrix A_B/N (intertial to body frame). Useful to convert an inertial vector into
    the body frame representation.
    :param q: [1x4] quaternion vector. The scalar component is supposed to be q[3].
    :return: [3x3] DCM matrix A_B/N (inertial to body frame).
    """
    return np.array([
